      ...
      <div className="px-4 md:px-10 max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div className="flex flex-col gap-6">
            <img src={vilaasaLogo} alt="Vilaasa Estate" className="h-10 w-fit" />
            ...
            <div className="flex flex-col gap-3 mt-2">
              <div className="flex items-start gap-2 text-muted-foreground text-sm">
                ...
                <span>43, 2nd Cross Street, 2nd Main Road, Navarathna Garden, Defence Colony, Ekkatuthangal, Chennai, Tamil Nadu 600032</span>
              </div>
              <div className="flex items-center gap-2 text-muted-foreground text-sm">
                <span className="material-symbols-outlined text-primary text-base">call</span>
                <a href="tel:04443570713" className="hover:text-foreground transition-colors">044 4357 0713</a>
              </div>
            </div>
          </div>
